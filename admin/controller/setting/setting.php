...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		} elseif ($this->config->get('config_footerlogo') && is_file(DIR_IMAGE . $this->config->get('config_footerlogo'))) {
			$data['footerlogo'] = $this->model_tool_image->resize($this->config->get('config_footerlogo'), 100, 100);
		} else {
